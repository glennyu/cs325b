...
from single_tweet_model.utils import Params
from single_tweet_model.utils import set_logger
from single_tweet_model.training import train_and_evaluate
from single_tweet_model.input_fn import input_fn
from single_tweet_model.input_fn import load_tweets_and_prices, load_word_embeddings, load_features
from single_tweet_model.model_fn import model_fn


parser = argparse.ArgumentParser()
parser.add_argument('--model_dir', default='experiments/single_tweet_model',
                    help="Directory containing params.json")
parser.add_argument('--json_file', default='experiments/single_tweet_model/params.json',
                    help="Directory containing params.json")
parser.add_argument('--results_dir', default='experiments/single_tweet_model/results',
...
if __name__ == '__main__':
    ...
    assert os.path.isfile(args.json_file), "No json configuration file found at {}".format(args.json_file)
    params = Params(args.json_file)
