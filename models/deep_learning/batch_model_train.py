...
from batch_model.utils import Params
from batch_model.utils import set_logger
from batch_model.training import train_and_evaluate
from batch_model.input_fn import input_fn
from batch_model.input_fn import load_tweets_and_prices, load_word_embeddings
from batch_model.model_fn import model_fn


parser = argparse.ArgumentParser()
parser.add_argument('--model_dir', default='experiments/batch_model',
                    help="Directory containing params.json")
parser.add_argument('--json_file', default='experiments/batch_model/params.json',
                    help="Directory containing params.json")
parser.add_argument('--results_dir', default='experiments/batch_model/results',
...
if __name__ == '__main__':
    ...
    json_path = os.path.join(args.json_file, '')
