...
from price_model.utils import save_dict_to_json
from price_model.evaluation import evaluate_sess
...
def train_and_evaluate(train_model_spec, eval_model_spec, results_dir, params, restore_from=None):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(begin_at_epoch, begin_at_epoch + params.num_epochs):
            ...
            train_sess(sess, train_model_spec, num_steps, epoch, train_writer, params)
            ...
            metrics = evaluate_sess(sess, eval_model_spec, num_steps, epoch, eval_writer, params)
