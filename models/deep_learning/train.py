...
if __name__ == '__main__':
    ...
    train_tweets, train_prices, train_tweet_dist, train_tweet_month_idx, train_monthly_price = load_tweets_and_prices(
        path_train_embeddings, path_train_batches, word_embeddings, tweet_feat, params)
    eval_tweets, eval_prices, eval_tweet_dist, eval_tweet_month_idx, eval_monthly_price = load_tweets_and_prices(
        path_eval_embeddings, path_eval_batches, word_embeddings, tweet_feat, params)

    # Create the two iterators over the two datasets
    train_inputs = input_fn('train', train_tweets, train_prices, train_tweet_dist, train_tweet_month_idx, train_monthly_price, params)
    eval_inputs = input_fn('eval', eval_tweets, eval_prices, eval_tweet_dist, eval_tweet_month_idx, eval_monthly_price, params)
    logging.info("- done.")
